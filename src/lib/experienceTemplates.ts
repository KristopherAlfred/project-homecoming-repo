...
import sloaneHero from "../assets/sloane-template-hero.mp4.asset.json";
...
export const EXPERIENCE_TEMPLATES: ExperienceTemplate[] = [
  ...
  },
  {
    ...
    swatches: ["#04070a", "#0a1b1f", "#CBD5DC", "#FFFFFF"],
    theme: {
      bg: "#04070a",
    ...
    landing: {
      ...
      stage: [
        { id: "hero", x: 0, y: 0, w: 100, h: 100, z: 4, glow: false, glowColor: "#E9EEF2", glowIntensity: 0 },
        { id: "logo", x: 14, y: 6.5, w: 12, z: 22, glow: true, glowColor: "#E9EEF2", glowIntensity: 45 },
        { id: "wordmark", x: 27, y: 7.5, w: 60, z: 21, scale: 118, glow: false, glowColor: "#FFFFFF", glowIntensity: 0 },
        { id: "tagline", x: 27, y: 11, w: 60, z: 20, scale: 112, glow: false, glowColor: "#E9EEF2", glowIntensity: 0 },
        { id: "titleArt", x: 10, y: 46, w: 70, z: 12, hidden: true, glow: false, glowColor: "#E9EEF2", glowIntensity: 0 },
        { id: "subhead", x: 8, y: 48, w: 84, z: 14, glow: false, glowColor: "#E9EEF2", glowIntensity: 22 },
        ...
        { id: "featureRow", x: 5, y: 70, w: 90, z: 16, glow: false, glowColor: "#E9EEF2", glowIntensity: 0 },
        { id: "cta", x: 6, y: 80, w: 88, z: 18, glow: true, glowColor: "#5CE9A6", glowIntensity: 40 },
        { id: "memberProof", x: 5, y: 88.5, w: 90, z: 17, glow: false, glowColor: "#E9EEF2", glowIntensity: 0 },
      ],
    },
  },

  {
    ...
    swatches: ["#050505", "#0A1A12", "#E9EEF2", "#FFFFFF"],
    theme: {
      bg: "#050505",
    ...
    effects: { glow: true, glowColor: "#E9EEF2", glowIntensity: 45, particles: false, vignette: true },
    brand: { wordmarkColor: "#E9EEF2", taglineColor: "#FFFFFF" },
  },
  {
    id: "court-crimson",
    label: "Court Crimson",
...
EXPERIENCE_TEMPLATES.unshift({
  ...
  swatches: ["#14181D", "#1B2129", "#C9D2DA", "#F4F7F9"],
  athlete: "Sloane Stephens",
  photo: "",
  theme: {
    bg: "#14181D",
    bgGradientFrom: "#1B2129",
    bgGradientVia: "#14181D",
    bgGradientTo: "#10141A",
    bgGradientAngle: 180,
    useGradientBg: true,
    accent: "#C9D2DA",
