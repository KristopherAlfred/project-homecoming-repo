      ...
      >
        ...
        >
          <button
            type="button"
            onClick={onJoin}
            className={`creator-primary-cta group inline-flex items-center justify-center gap-2 rounded-full transition-all duration-200 ease-out hover:scale-[1.02] active:scale-[0.98] active:brightness-[0.96] ${
